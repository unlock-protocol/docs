        ...
        <div className="card">
          ...
          <div className="card__body">
            <dl>
              ...
              <dd>
                <a href="/img/tutorial/react-example-fork_button.png">
                  <img src="/img/tutorial/react-example-fork_button.png" alt="fork image">
                </a>
              </dd>
              ...
              <dt>Front-end tutorial</dt>
              <dd>
                video still 3
              </dd>
              <dt>Back-end tutorial</dt>
              <dd>
                video still 4
              </dd>
            </dl>
